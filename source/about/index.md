...
雷昕，现为中国地质大学（北京）数理学院副教授、博士研究生指导教师。本人从事计算流体力学、高能天文学相关的研究工作，包括可压缩多介质流问题的数值方法（涉及数值模拟多介质流物质界面处的物理过程、抑制物质界面处的数值不稳定性现象）、伽马射线暴现象（涉及相对论性喷流的传播及辐射过程）。已经以第一作者在J. Comput. Phys., Phys. Fluids, Comput. Fluids等知名SCI期刊发表多篇学术论文。
...
[超新星爆发与伽马射线暴](/about/SN_GRB.ppsx) (<https://365.kdocs.cn/l/caPQOJuDjYgG>)
