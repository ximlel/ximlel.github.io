...
雷昕，现为中国地质大学（北京）数理学院副教授、硕士研究生指导教师、数据计算及应用专业2021级本科生班主任、百度飞桨AI For Science学术导师。本人长期从事计算流体力学相关的研究工作，主要研究可压缩多介质流问题的数值方法，涉及数值模拟多介质流物质界面处的物理过程、抑制物质界面处的数值不稳定性现象。已经以第一作者在J. Comput. Phys., Phys. Fluids, Comput. Fluids等知名SCI期刊发表多篇学术论文。
...
* 教授研究生课程：偏微分方程数值解、应用时间序列分析、科技论文选题与写作
...
* 招收研究生方向：数学（双曲偏微分方程数学理论、计算流体力学、爆轰、空间/天体物理计算），统计学（全日制：天文统计学；非全日制：时间序列分析），计算机技术（计算机图形学——物理引擎）。
